"""神煞引擎 — 问真八字口径（2026-08-20：29 种 + 问真独有 28 种，250 案例覆盖率 100%）。
...
# ---------------------------------------------------------------- 吉凶标注
# 问真独有 28 种（2026-08-20 校准补全）：吉——德秀/月德/天德/天德合/月德合/天医/
...
def _per_pillar_rules(pillars: List[str], gender: str) -> dict:
    ...
    # ---- 问真独有 28 种（250 案例全量反推，2026-08-20 校准）----
