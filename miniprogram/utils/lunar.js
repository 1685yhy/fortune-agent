...
/* 农历月/日名。
 * 日名口径 = 引擎权威侧（src/engines/zeri.py:_lunar_day_cn /
 * src/engines/wannianli.py:_lunar_day_cn，二者逐字相同）：初一..初十 /
 * 十一..十九 / 二十 / 廿一..廿九 / 三十。k70-F1 前 10 项误作「一..十」，
 * 导致前端「二月八日」与引擎「二月初八日」在农历日 1-10（约 1/3 的日子）
 * 前后端分裂。**本表是前端唯一事实源，改动必须与引擎口径同步。** */
